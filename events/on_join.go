	...
	bot.ChannelMessageSendComplex(config.WelcomeChannelId, &discordgo.MessageSend{
		...
		Embed: embed_helper.CustomWithFields(
			...
			[]*discordgo.MessageEmbedField{
				...
				embed_helper.CreateField("Whatsapp", "[Lihat Whatsapp](https://wa.me/5285888881550)", true),
				embed_helper.CreateField("Instagram (tidak aktif)", "[Lihat Instagram](https://shopee.co.id/gprestore)", true),
			},
			embed_helper.WHITE,
		),
	})
